  ...
  <div style={{ flex: '1', minWidth: '260px' }}>
    ...
    <div style={{ padding: '1rem 0', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.75rem' }}>
        ...
        <a href="https://github.com/zams0527-eng/Yoru-Reader/raw/main/downloads/Yoru-Reader%20Setup%201.1.0.exe"
      ...
      <ol style={{ margin: '0', paddingLeft: '1.25rem', color: 'rgba(255,255,255,0.6)', fontSize: '0.85rem', lineHeight: '1.7' }}>
        <li>Descarga el instalador ejecutable (<code>Yoru-Reader Setup 1.1.0.exe</code>).</li>
  ...
  <div style={{ flex: '1', minWidth: '260px' }}>
    ...
    <div style={{ padding: '1rem 0', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.75rem' }}>
        ...
        <a href="https://github.com/zams0527-eng/Yoru-Reader/raw/main/downloads/Yoru-Reader-1.1.0.apk"
           target="_blank" rel="noopener noreferrer"
           style={{ color: 'var(--yc-yellow)', textDecoration: 'none', fontSize: '0.9rem', fontWeight: '600' }}>
          ↓ Yoru Reader (.apk)
        </a>
      ...
      <ol style={{ margin: '0', paddingLeft: '1.25rem', color: 'rgba(255,255,255,0.6)', fontSize: '0.85rem', lineHeight: '1.7' }}>
        <li>Descarga el archivo <code>.apk</code> (<code>Yoru-Reader-1.1.0.apk</code>) en tu móvil.</li>
